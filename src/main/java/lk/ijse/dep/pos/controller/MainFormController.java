...
public class MainFormController implements Initializable {
    ...
    /**
     * Initializes the lk.ijse.dep.lk.ijse.dep.pos.controller class.
     */
    ...
    private String getHost(){
        return env.getProperty("ijse.dep.ip");
    }
    private String getPort(){
        return env.getProperty("ijse.dep.port");
    }
    private String getDatabase(){
        return env.getProperty("ijse.dep.db");
    }
        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    ...
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.lk.ijse.dep.pos.view customers");
                    break;
                case "imgItem":
                    lblMenu.setText("Manage Items");
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.lk.ijse.dep.pos.view items");
                    break;
                case "imgOrder":
    ...
    public void btnRestore_OnAction(ActionEvent actionEvent) {
        try {
            ...
            Logger.getLogger("lk.ijse.dep.lk.ijse.dep.pos.controller.MainFormController").log(Level.SEVERE, null, ex);
        }
    }
