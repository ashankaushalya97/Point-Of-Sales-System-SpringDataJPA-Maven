...
public class PlaceOrderFormController {
    ...
    public void initialize() {
        ...
        try {
            ...
            Logger.getLogger("lk.ijse.dep.lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
        }
...
//            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/dep/lk.ijse.dep.pos/report/order-report.jasper"));
